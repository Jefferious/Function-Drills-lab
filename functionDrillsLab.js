...
let oddChecker = thatsOdd(98489456186)
...
// console.log(bestMovie('Princess bride'))
...
//CODE HERE
const oneArgument = (string) => {
  console.log(string.toUpperCase())
}
oneArgument(sampleString)
